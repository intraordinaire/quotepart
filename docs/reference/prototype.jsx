...
const Icons = {
  ...
  sliders: (
    ...
    >
      ...
      <circle cx="7" cy="5" r="2" fill="var(--accent)" stroke="var(--accent)" />
      <circle cx="12" cy="10" r="2" fill="var(--accent)" stroke="var(--accent)" />
      <circle cx="9" cy="15" r="2" fill="var(--accent)" stroke="var(--accent)" />
    </svg>
  ),
  users: (
    <svg
    ...
    >
      ...
      <path d="M13 12.5c2.5 0 4.5 2 4.5 4.5" />
    </svg>
  ),
  sparkle: (
    <svg
  ...
  edit: (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M9 3H3a1 1 0 00-1 1v10a1 1 0 001 1h10a1 1 0 001-1V9" />
      <path d="M13.5 1.5a1.4 1.4 0 012 2L9 10l-3 1 1-3 6.5-6.5z" />
    </svg>
  ),
  results: (
    <svg
  ...
  return (
    <div style={{ minHeight: "100vh" }}>
        ...
        >
          {[
            ...
            >
              ...
              >
                <span style={{ color: item.accent ? "var(--accent)" : "var(--text)" }}>
                  {item.icon}
                </span>
                <span
                  style={{
      ...
      >
        ...
        >
          Aucun modèle n'est "le bon". L'outil vous les montre tous pour que vous choisissiez celui
          qui correspond à votre couple.
        </p>
        ...
        {tabs.map((tab) => (
          <button
            ...
            style={{
              ...
              border: "none",
              borderBottom:
                activeTab === tab.id ? "2px solid var(--text)" : "2px solid transparent",
      ...
      >
          ...
          <div style={{ display: "flex", flex: 1, width: "100%" }}>
            ...
            >
              <div style={{ padding: "0 20px", marginBottom: 20 }}>
                ...
                >
                  <div
                    style={{
                      height: "100%",
                      width: `${Math.max(activePalier, 0) * 25}%`,
                      background: "var(--accent)",
                      borderRadius: 2,
              ...
              {paliers.map((p) => (
                <button
                  key={p.n}
                  onClick={() => fillMode && setActivePalier(p.n)}
                  style={{
                    display: "flex",
                    ...
                    width: "100%",
                    padding: "12px 20px",
                    background: activePalier === p.n ? "var(--surface)" : "transparent",
                    border: "none",
                    borderLeft:
                      activePalier === p.n ? "2px solid var(--accent)" : "2px solid transparent",
                    cursor: fillMode ? "pointer" : "default",
                    textAlign: "left",
                    transition: "all 0.15s",
            ...
            <main style={{ flex: 1, padding: "32px 40px", maxWidth: 640 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                    ...
                    >
                      ...
                      <div>
                        ...
                        >
                          Vous saisissez les données des deux personnes. Résultats immédiats. Vous
                          pourrez ensuite partager un lien pour que votre partenaire ajuste ses
                          données.
                        </div>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div>
                        ...
                        >
                          Vous saisissez vos données et les charges communes. Votre partenaire
                          recevra un lien pour compléter les siennes. Plus juste, notamment pour la
                          charge domestique.
                        </div>
                        <div
                          style={{
              ...
              {activePalier === 2 && (
                <div className="fade-in">
                  ...
                  <p style={{ color: "var(--text-secondary)", fontSize: 13, marginBottom: 6 }}>
                    Les dépenses qui grèvent le reste à vivre de chacun. Débloque le modèle Reste à
                    vivre égal.
                  </p>
                  <p
                    style={{
              ...
              {activePalier === 3 && (
                <div className="fade-in">
                  ...
                  <p style={{ color: "var(--text-secondary)", fontSize: 13, marginBottom: 6 }}>
                    Le temps partiel a un coût. Ce palier le rend visible. Débloque le modèle Ajusté
                    temps.
                  </p>
                  <p
                    style={{
                  ...
                  >
                    <div>
                      ...
                      <SelectField
                        label="Quotité"
                        options={["Temps plein (100%)", "90%", "80%", "Mi-temps (50%)", "Autre"]}
                        defaultVal="Temps plein (100%)"
                      />
                    </div>
                    <div>
                      <div
                        ...
                        <>
                          ...
                          <div style={{ marginTop: 12 }}>
                            <SelectField
                              label="Motif"
                              options={[
                                "Choix du couple (enfants)",
                                "Choix personnel",
                                "Contrainte médicale",
                              ]}
                              defaultVal="Choix du couple (enfants)"
                            />
                          </div>
                        </>
                      )}
              ...
              {activePalier === 4 && (
                <div className="fade-in">
                  ...
                  >
                    Heures de référence basées sur l'Enquête Emploi du Temps (INSEE). Valorisation :
                    SMIC net horaire (9,57 €/h).{" "}
                    <span style={{ textDecoration: "underline", cursor: "pointer" }}>
                      Modifier la valeur horaire
                    </span>
                  </div>
                  ...
                  >
                    ...
                    {isShared ? (
                      ...
                      <div style={{ display: "flex", gap: 10 }}>
                        ...
                        >
                          <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
                            {Icons.users} Lien de correction
                          </span>
                          <span style={{ fontSize: 10, color: "var(--text-tertiary)" }}>
                            Léa pourra ajuster ses données
                          </span>
                        </button>
                      </div>
                    )}
        ...
        {activeTab === "resultats" && (
          <main style={{ flex: 1, padding: "32px 40px", maxWidth: 960 }} className="fade-in">
            ...
            <p style={{ color: "var(--text-secondary)", fontSize: 13, marginBottom: 28 }}>
              5 modèles d'équité appliqués à votre situation. Cliquez sur un modèle pour voir le
              détail.
            </p>
            ...
            >
              ...
              {[
                ...
                >
                  ...
                  <span style={{ fontSize: 12, fontWeight: 600, width: 36, color: g.color }}>
                    {g.pct}%
                  </span>
                </div>
              ))}
            ...
            >
              ...
              >
                En 50/50, au bout de 10 ans, Thomas aura pu épargner{" "}
                <strong style={{ color: "var(--accent)" }}>132 000 €</strong> de plus que Léa. En
                modèle reste à vivre égal, cet écart tombe à{" "}
                <strong style={{ color: "var(--green)" }}>31 200 €</strong>.
              </p>
            </div>
        ...
        {activeTab === "whatif" && (
          <main style={{ flex: 1, padding: "32px 40px" }} className="fade-in">
            ...
            <p style={{ color: "var(--text-secondary)", fontSize: 13, marginBottom: 28 }}>
              Modifiez n'importe quel paramètre. Les résultats se recalculent en temps réel.
            </p>
            ...
            >
                ...
                <div style={{ fontSize: 13, display: "flex", flexDirection: "column", gap: 10 }}>
                  ...
                  >
                    ...
                    <div style={{ marginTop: 6 }}>
                      <InfoRow label="Écart RAV (prorata)" value="478 €" highlight />
                    </div>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div style={{ fontSize: 13, display: "flex", flexDirection: "column", gap: 10 }}>
                  ...
                  <div
                    style={{
                      borderTop: "1px solid rgba(212,89,58,0.2)",
                      paddingTop: 10,
                      marginTop: 4,
                    }}
                  >
                    ...
                    <div style={{ marginTop: 6 }}>
                      <InfoRow label="Écart RAV (prorata)" value="215 €" highlightGreen />
                    </div>
                  </div>
                </div>
              </div>
            ...
            >
              <strong>Impact du retour à temps plein de Léa :</strong> l'écart de reste à vivre en
              modèle prorata passe de 478 € à 215 € par mois, soit{" "}
              <strong style={{ color: "var(--green)" }}>3 156 € d'écart en moins par an</strong>.
            </div>
          </main>
        )}
      </div>
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div style={{ flex: 1, position: "relative" }}>
          <input
            ...
            style={{
              ...
              height: 4,
              appearance: "none",
              background: `linear-gradient(to right, var(--text) 0%, var(--text) ${val}%, var(--accent) ${val}%, var(--accent) 100%)`,
              borderRadius: 2,
              outline: "none",
              cursor: "pointer",
            }}
        ...
        <span style={{ fontSize: 11, fontWeight: 600, color: "var(--accent)", width: 55 }}>
          {rightName}
        </span>
      </div>
      <div
        style={{ textAlign: "center", fontSize: 11, color: "var(--text-tertiary)", marginTop: 2 }}
      >
        {val}% / {100 - val}%
      </div>
    </div>
  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-between" }}>
      ...
      <span
        style={{
          fontWeight: 600,
          color: highlight ? "var(--accent)" : highlightGreen ? "var(--green)" : "var(--text)",
          fontVariantNumeric: "tabular-nums",
        }}
      >
        {value}
