 ...
 * NOTE: soft privacy, not cryptographic. Encryption is planned for v1.1.
 */
 ...
 */
export function getP2InviteLink(
  input: Pick<SimulationInput, "commonCharges" | "hasChildren" | "hourlyRate"> & {
    p1: { name: string };
  }
): string {
